/* global myneIsDarkMode, setTimeout */

// Check the color scheme preference and inject the classes if necessary.
if ( document.body.classList.contains( 'myne-supports-dark-theme' ) ) {
	myneDarkModeEditorInit();
}
 ...
 * @return {void}
 */
function myneDarkModeEditorInit( attempt ) {
	...
	if ( myneIsDarkMode() ) {
		if ( null === container ) {
			...
			if ( attempt < maxAttempts ) {
				setTimeout(
					function() {
						myneDarkModeEditorInit( attempt + 1 );
					},
