...
if ( ! class_exists( 'myne_Customize' ) ) {
	/**
	 * Customizer Settings.
	 *
	 * @since MYNE 1.0
	 */
	class myne_Customize {
		...
		public function register( $wp_customize ) {
			...
			$wp_customize->add_control(
				...
				array(
					...
					'label'   => esc_html__( 'Display Site Title & Tagline', 'myne' ),
				)
			);
			...
			$wp_customize->add_section(
				'excerpt_settings',
				array(
					'title'    => esc_html__( 'Excerpt Settings', 'myne' ),
					'priority' => 120,
				)
			);
			...
			$wp_customize->add_control(
				...
				array(
					...
					'label'   => esc_html__( 'On Archive Pages, posts show:', 'myne' ),
					'choices' => array(
						'excerpt' => esc_html__( 'Summary', 'myne' ),
						'full'    => esc_html__( 'Full text', 'myne' ),
					),
				)
			);
			...
			$wp_customize->register_control_type( 'myne_Customize_Color_Control' );
			...
			$wp_customize->add_control(
				new myne_Customize_Color_Control(
					$wp_customize,
					'background_color',
					array(
						'label'   => esc_html_x( 'Background color', 'Customizer control', 'myne' ),
						'section' => 'colors',
						'palette' => $colors,
					)
				)
